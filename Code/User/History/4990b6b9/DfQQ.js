...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function applyPywalTheme() {
        fetch("file:///home/kaushik/.cache/wal/colors.json")
            ...
            .then(colors => {
                document.documentElement.style.setProperty("--bg-color-blue", colors.background);
                ...
                document.documentElement.style.setProperty("--textColorDark-blue", colors.foreground);
                document.documentElement.style.setProperty("--whitishColor-blue", colors.color4);
                changeFaviconColor();
                ApplyLoadingColor();
            })
