...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function applyPywalTheme() {
        fetch("file:///home/kaushik/.cache/wal/colors.json")
            ...
            .then(colors => {
                document.documentElement.style.setProperty("--bg-color-blue", data.colors.color0);
                document.documentElement.style.setProperty("--accentLightTint-blue", data.colors.color0);
                document.documentElement.style.setProperty("--darkerColor-blue", data.colors.color0);
                document.documentElement.style.setProperty("--darkColor-blue", data.colors.color0);
                document.documentElement.style.setProperty("--textColorDark-blue", data.colors.color0);
                document.documentElement.style.setProperty("--whitishColor-blue", data.colors.color0);
                changeFaviconColor();
                ApplyLoadingColor();
            })
